...
from .data import PokemonPlatinumData, TrainerPokemonDataTypeEnum, data
...
class PokemonPlatinumDeltaPatch(APDeltaPatch):
...
def generate_output(world: "PokemonPlatinumWorld", output_directory: str) -> None:
    ...
    patch = PokemonPlatinumDeltaPatch(os.path.splitext(output_path)[0] + ".applatinum", player=world.player,
...
def _set_species_info(world: "PokemonPlatinumWorld", rom: bytearray) -> None:
...
def _set_opponents(world: "PokemonPlatinumWorld", rom: bytearray) -> None:
...
def _set_static_encounters(world: "PokemonPlatinumWorld", rom: bytearray) -> None:
...
def _set_starters(world: "PokemonPlatinumWorld", rom: bytearray) -> None:
...
def _set_tm_moves(world: "PokemonPlatinumWorld", rom: bytearray) -> None:
...
def _set_tmhm_compatibility(world: "PokemonPlatinumWorld", rom: bytearray) -> None:
...
def _randomize_opponent_battle_type(world: "PokemonPlatinumWorld", rom: bytearray) -> None:
